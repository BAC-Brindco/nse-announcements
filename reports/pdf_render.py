"""
HTML → PDF for the daily announcements report.
...
logger = logging.getLogger("nse.announcements.pdf")

# A4 with room for the fixed-width email card. The body does not reflow, so we
# scale rather than re-lay-out; print_background keeps the panel fills.
_PDF_OPTS = {
    "format": "A4",
